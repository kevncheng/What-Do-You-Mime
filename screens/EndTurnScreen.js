        ...
        return (
            <View style={parentContainer}>
                ...
                <View style={pointContainer}>
                    <View style={{ flex: 1 }}>
                        <Text style={[importantText, { fontSize: SCREEN_WIDTH * 0.05 }]}>
                            Team One:{' '}
                        </Text>
                ...
                <View style={buttonPosition}>
                    <Button
                        ...
                        onPress={() => Actions.interval({ type: 'reset' })}
...
const mapStateToProps = state => {
    const { passes, rounds, turn, gameRound, TeamOnePoints, TeamTwoPoints } = state.setting;
